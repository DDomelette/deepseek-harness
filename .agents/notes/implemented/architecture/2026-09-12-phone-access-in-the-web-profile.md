...
- Terminal output for the join URL is gone; the loopback URL line, the LAN URL line, and the plain-HTTP warning remain `dsh-web-app`'s readiness output.
