...
Source: [`packages/notes/notes/src/settings.ts:76`](../packages/notes/notes/src/settings.ts)
...
Source: [`packages/skill/skill/src/index.ts:272`](../packages/skill/skill/src/index.ts)
...
Source: [`packages/telemetry/usage-exporter/src/index.ts:12`](../packages/telemetry/usage-exporter/src/index.ts)
...
- `@deepseek-ai/dsh-mob` — requires `webServer` · `connection` ([`packages/bundle/mob/src/index.ts`](../packages/bundle/mob/src/index.ts))
