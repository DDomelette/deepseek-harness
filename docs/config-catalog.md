...
Requires: `agentDefaultModel` · `agents` · `attachments` · `directoryPicker` · `llm` · `sessions` · `subagents` · `sessionQuery` · `sessionFlags` · `tools` · `userQuestions` · `workspaceRegistry`
...
Source: [`packages/skill/skill/src/index.ts:271`](../packages/skill/skill/src/index.ts)
