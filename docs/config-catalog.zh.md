...
需要：`agentDefaultModel` · `agents` · `attachments` · `directoryPicker` · `llm` · `sessions` · `subagents` · `sessionQuery` · `sessionFlags` · `tools` · `userQuestions` · `workspaceRegistry`
...
来源：[`packages/skill/skill/src/index.ts:271`](../packages/skill/skill/src/index.ts)
