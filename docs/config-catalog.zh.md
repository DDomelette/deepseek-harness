...
- `@deepseek-ai/dsh-session-deletion` — requires `sessions` · `sessionPersistence` · `storageDomain` ([`packages/session/session-deletion/src/index.ts`](../packages/session/session-deletion/src/index.ts))
- `@deepseek-ai/dsh-session-flags` ([`packages/session/session-flags/src/index.ts`](../packages/session/session-flags/src/index.ts))
- `@deepseek-ai/dsh-session-pins` — requires `storageDomain` · `sessionFlags` ([`packages/session/session-pins/src/index.ts`](../packages/session/session-pins/src/index.ts))
...
- `@deepseek-ai/dsh-skill-settings` — requires `skills` ([`packages/skill/skill-settings/src/index.ts`](../packages/skill/skill-settings/src/index.ts))
