...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  sessionFlags: 'session.md',
  sessionPins: 'session.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SkillInvocationOverride: 'skills.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SessionFlagProvider: 'session flag provider contract is owned by packages/session/session-flags/README.md',
  SessionFlagsSnapshot: 'session flag projection is owned by packages/session/session-flags/README.md',
  SessionPinsSnapshot: 'durable pin state is owned by packages/session/session-pins/README.md',
