...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SessionFlagsSnapshot: 'Service-local type documented in packages/session/session-flags/README.md',
  SessionPinsSnapshot: 'Service-local type documented in packages/session/session-pins/README.md',
  SkillInvocationOverride: 'Service-local type documented in packages/skill/skill/README.md',
