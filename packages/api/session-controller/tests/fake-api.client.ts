...
export class FakeApiClient {
  ...
  workspaceBaseline: Extract<WorkspaceFollowFrame, { type: 'baseline' }>['value'] = { archivedSessionAts: {},
    items: [],
    archivedSessionIds: [],
  }
  ...
  onWorkspaceArchiveSession: (payload: unknown) => Promise<RemoteResult<{
    ...
    payload => Promise.resolve(ok({ archivedSessionAts: {}, archivedSessionIds: [(payload as { sessionId: SessionId }).sessionId] }))
  ...
  sessionRemotes(): RuntimeRemotes {
    return {
      ...
      session: {
        delete: payload => Promise.resolve(ok({ deletedSessionIds: [payload.sessionId] })),
      ...
      workspace: {
        list: () => Promise.resolve(ok(this.workspaceBaseline)),
        unarchiveSession: () => Promise.resolve(ok({ archivedSessionAts: {}, archivedSessionIds: [] })),
