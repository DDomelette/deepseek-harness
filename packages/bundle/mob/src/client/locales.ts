...
export const en = {
  ...
  'panel.lifetimeNote': 'A longer window reaches the phone the next time it loads the page, while its current cookie is still valid; a device whose window already ended must pair again.',
...
export const zh: Record<MobileSettingsKey, string> = {
  ...
  'panel.lifetimeNote': '延长后，手机下一次打开页面时生效，前提是它当前的 cookie 仍然有效；窗口已经结束的设备必须重新配对。',
