...
/**
 * Validate an untrusted pairing code against the generator's alphabet and length.
 * @param code - code received from a URL or decision body.
 * @returns whether the code could have been generated by this Host.
 */
export function isPairingCode(code: string): boolean {
  return code.length === CODE_LENGTH && code.split('').every(character => CODE_ALPHABET.includes(character))
}
