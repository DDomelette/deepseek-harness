...
export const zh = {
  ...
  'error.imageNotSubmittable': '截图只存了附件引用，本版还不能把它提交给模型。',
  'panel.addImage': '添加截图',
  'panel.image': '截图',
...
export const en = {
  ...
  'error.imageNotSubmittable': 'The screenshot holds only an attachment reference, which this build cannot submit to a model yet.',
