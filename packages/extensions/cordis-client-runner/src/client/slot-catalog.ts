...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-plugins UsageTelemetryCard',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-archived ArchivedSection id \'archived\'',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Pinned-sessions section above the project tree (declared by the WorkspaceBrowser entry).',
    doc: 'Pinned-sessions section above the project tree (declared by the WorkspaceBrowser entry).',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      'client-ui-pinned-sessions PinnedSection',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'sidebar.workspaces.searchResultExtra',
    kind: 'list',
    scope: 'root',
    summary: 'Extra marker in search-result rows (declared by the WorkspaceBrowser entry).',
    doc: 'Extra marker in search-result rows (declared by the WorkspaceBrowser entry).',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      'client-ui-pinned-sessions SearchPinBadge id \'pin\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.searchResultExtra\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.searchResultExtra\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:87',
  },
  {
    key: 'sidebar.workspaces.sessionActions',
    kind: 'list',
    scope: 'root',
    summary: 'Per-row actions before the ellipsis menu (declared by the WorkspaceBrowser entry).',
    doc: 'Per-row actions before the ellipsis menu (declared by the WorkspaceBrowser entry).',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      'client-ui-pinned-sessions SessionPinAction id \'pin\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.sessionActions\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.sessionActions\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:85',
  },
  {
