...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      {
        signature: '@Remote(\'delete\') async deleteSession(request: { sessionId: SessionId; recursive: boolean }): Promise<{ deletedSessionIds: SessionId[] }>',
        description: 'Permanently delete a Session and its descendants after closing idle Agents.',
        parameters: [{ name: 'request', description: 'root Session and explicit recursion choice.' }],
  ...
  },
  {
    ...
    methods: [
      {
        signature: 'delete( input: { readonly sessionId: SessionId; readonly recursive: boolean }, detach?: (ids: readonly SessionId[]) => Promise<void>, ): Promise<{ readonly deletedSessionIds: SessionId[] }>',
        description: 'Permanently delete one session and, when `recursive` is true, its descendant subagent sessions leaves-first.',
        parameters: [{ name: 'input', description: 'target and recursion switch.' }, { name: 'detach', description: 'optional lifecycle owner that closes idle Agents before destructive writes.' }],
    ...
    methods: [
      {
        ...
        description: 'Permanently remove a stored Session and its artifacts after all writers close. Explicit deletion removes every committed generation; migration alone never does.',
        parameters: [{ name: 'id', description: 'Session whose durable data is removed.' }],
        returns: 'completion after removal; missing Sessions reject.',
        throws: ['{SessionAlreadyOwnedError} while a writer owns the Session.', '{SessionPersistenceNotFoundError} when no stored Session exists.'],
      },
      {
    ...
    methods: [
      {
        ...
        description: 'List skills available through the Session\'s slash commands.',
        parameters: [{ name: 'request', description: 'Session whose composition selects the catalog.' }, { name: 'signal', description: 'caller lifetime.' }],
        returns: 'user-invocable metadata without skill bodies.',
      },
      {
        signature: '@Remote async catalog(request: SkillListRequest, signal: AbortSignal): Promise<SkillCatalogValue>',
        description: 'List every skill, including disabled entries, for the settings page.',
        parameters: [{ name: 'request', description: 'Session whose composition selects the catalog.' }, { name: 'signal', description: 'caller lifetime.' }],
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Restore one archived Session to its retained grouping position.',
        parameters: [{ name: 'request', description: 'Session to restore.' }],
        returns: 'the resulting archive set and recorded instants.',
      },
      {
        signature: '@Remote(\'list\') list(): WorkspaceBaseline',
        description: 'Read the complete Workspace projection for an explicit refresh.',
        parameters: [],
...
export const EVENT_API: readonly EventApiEntry[] = [
  ...
  {
    name: 'mcp-servers/change',
    mode: 'emit',
    signature: '\'mcp-servers/change\'(): void',
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'SessionFlags',
    declaration: 'export interface SessionFlags {\n    readonly pinned?: boolean;\n}',
  },
  {
  ...
  },
  {
    ...
    declaration: 'export interface SkillCatalogEntry {\n    readonly name: string;\n    readonly description: string;\n    readonly whenToUse?: string;\n    readonly group?: string;\n    readonly source: string;\n    readonly modelInvocable: boolean;\n    readonly userInvocable: boolean;\n    readonly disabled: boolean;\n}',
  },
  {
  ...
  {
    name: 'SkillCatalogValue',
    declaration: 'export interface SkillCatalogValue {\n    readonly skills: readonly SkillCatalogEntry[];\n}',
  },
  {
