...
| [`ui-settings-mcp/`](ui-settings-mcp/README.md) | Contributes the MCP server roster tab to Plugins settings. |
...
| [`ui-settings-skills/`](ui-settings-skills/README.md) | Contributes the Skills settings section with per-skill enablement. |
