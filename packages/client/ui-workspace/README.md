...
The rows derive status priority locally and pass the ordered localized labels to the UI primitives' `StatusDots`, which keeps secondary activity accessible without adding visual markers.
