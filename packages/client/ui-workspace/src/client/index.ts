...
export type { UiWorkspace, WorkspaceSessionFlags } from './navigation.ts'
export type {
...
export function apply(ctx: Context): void {
  ...
  const browserInjected = (): WorkspaceBrowserInjected => ({
    ...
    hooks: { directoryFlow: browserFlowSource, hostInfo, workspaceSessionFlags: uiWorkspace.sessionFlags },
  })
