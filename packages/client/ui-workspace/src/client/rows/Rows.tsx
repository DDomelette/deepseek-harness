...
function SessionHoverContent({ node, now, t }: { node: SessionNode; now: number; t: RowTranslate }) {
  ...
  return (
    <div className={css.hoverContent}>
      ...
      {node.workspace !== undefined && <div className={css.hoverTime}>{node.workspace}</div>}
 ...
 */
export function SearchResultItem({ result, currentId, onOpen, extra, t }: {
...
export function SessionNodeItem({
  node, currentId, now, onOpen, onRename, onFork, onArchive, onReveal, drag, flat = false, extraActions, t,
}: {
  node: SessionNode
