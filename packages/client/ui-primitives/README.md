...
| `Tooltip` | Hover text on a cloned anchor, placed right, bottom, or top; fires only on hover-capable fine pointers, so a tap never sticks a bubble. |
