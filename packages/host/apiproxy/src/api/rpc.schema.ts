...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('session-running'), message: z.string(), details: z.object({ runningSessionIds: z.array(z.string()) }) }),
  z.object({ code: z.literal('session-has-descendants'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  z.object({ code: z.literal('session-deletion-unavailable'), message: z.string(), details: z.object({}) }),
